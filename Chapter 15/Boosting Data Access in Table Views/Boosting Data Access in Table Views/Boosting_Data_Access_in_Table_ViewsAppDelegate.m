//
//  Boosting_Data_Access_in_Table_ViewsAppDelegate.m
...
- (NSManagedObjectModel *)managedObjectModel
{
  ...
  NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Boosting_Data_Access_in_Table_Views" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
  ...
  NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Boosting_Data_Access_in_Table_Views.sqlite"];
