//
//  Creating_and_Saving_Data_Using_Core_DataAppDelegate.m
...
- (NSManagedObjectModel *)managedObjectModel
{
  ...
  NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Creating_and_Saving_Data_Using_Core_Data" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
  ...
  NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Creating_and_Saving_Data_Using_Core_Data.sqlite"];
