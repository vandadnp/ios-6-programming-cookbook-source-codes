//
//  Sorting_Data_in_Core_DataAppDelegate.m
...
#import "Sorting_Data_in_Core_DataAppDelegate.h"
#import "Person.h"

@implementation Sorting_Data_in_Core_DataAppDelegate
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Sorting_Data_in_Core_Data" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Sorting_Data_in_Core_Data.sqlite"];
